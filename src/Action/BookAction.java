...
public class BookAction extends HttpServlet {
    ...
    private void Searchbook(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Book> bookArrayList = bdao.QueryBook(searchinput);
        HttpSession session = request.getSession();
        session.setAttribute("searchbooklist", bookArrayList);
	...
	private void getAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*通过request对象提供的getRequestDispatche(String path)方法，该方法返回一个RequestDispatcher对象，
    ...
    private void QueryBookById(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if(next.equals("check"))
            ...
            out.write(book.getName() + "||" + book.getAuthor() + "||" + book.getPublisher()+ "||"+(book.getStore()-book.getLend()));
        }
