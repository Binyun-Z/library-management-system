    ...
    function readercheckResult(){
        ...
        if (xmlHttp.readyState==4 && xmlHttp.status==200){
            ...
            var getreaderstatus = parameters[1];
            var getreaderborrow = parameters[2];
            
            console.log(getreadername);
            if(getreadername == "null"){
                readername.value = "NUllname";
                readerstatus.value = "Nullstatus";
				readerborrow.value = "NULLvalues";
